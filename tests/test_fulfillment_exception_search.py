...
def test_exception_details_are_loaded_with_search_query_not_n_plus_one(
    ...
    # batch-code dropdown's option list + 1 for the bulk-move-batch
    # dropdown's option list (non-archived batches, for the checkbox
    # -selection bulk actions) + 1 for that same dropdown's consignor
